...
I am a passionate and adaptive **Platform Engineer** who currently works for Just Eat Takeaway in the Continuous Delivery Engineering team. Before working in tech I studied environment & development geography and worked in Marketing & PR. 
...
|-----------|---------|------------|-----|
|[Second Life](https://github.com/jamesoddy8/Second_Life)|Team project based on #techforgood. An app where users can upcycle their belongings, giving perfectly good items a "Second Life" rather than ending up in landfill. |Ruby on Rails, Javascript, Bootstrap, PostgreSQL, Heroku|[Second Life Demo](http://second-life-app.herokuapp.com/)|
